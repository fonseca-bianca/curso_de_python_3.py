...
# O método __init__ é definido para receber dois parâmetros: self e func.
# O Python passa o 1º parâmetro 'self' automaticamente (implícito), q é a 
# instância da classe que está sendo criada 'DecoradorCurto'
# o 2º parâmetro é 'func', q recebe a função que está sendo decorada 'saudar()'
