...
- Stack Overflow: estouro de pilha, ou seja, quando a pilha de chamadas
  de função fica muito grande e o interpretador do Python não consegue ler e 
  estoura a memória do computador;
...
print(factorial(1000)) 
    ...
    RecursionError: maximum recursion depth exceeded:
        ...
        justamente pra evitar o Stack Overflow).

    ** OBS.:
        Uma possível solução é configurar o Recursion Limit do Python:
            aq iremos setar o limite de recursão q queremos
        
        import sys
        sys.setrecursionlimit(1500) # esse será o novo limite de recursão
"""
