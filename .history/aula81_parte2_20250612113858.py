...
# própria função 'exibir()'. Exibindo logo após a criação de cada lista
...
# OBS.:
#     Se inverter a ordem e chamar exibir() antes de ordenar, ela vai imprimir
#     a lista sem ordenação ainda.
