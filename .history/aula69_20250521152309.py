...
escopo_externo() # vai imprimir 10 como valor da função escopo_externo() e
# tbm vai imprimir 11 e 20 como valor da função escopo_interno(), pois esta 
# função está dentro da função escopo_externo()
print(x) # vai imprimir 1
