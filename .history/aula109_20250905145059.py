...
# print(*list(iterator), sep="\n"):
#   list(iterator): 1º, a função converte o iterador q recebe em uma lista 
#   Isso é necessário pq ITERADORES SÓ PODEM SER CONSUMIDOS 1x 
#   Ao converter o iterador pra uma lista, ocorre a "captura" de todos os 
#   itens e eles serão impressos
#
# *: 
#   O asterisco (unpacking) "desempacota" cada item da lista como um arg
#   individual para a função print(). 
#   ex.: print(*[1, 2, 3]) é o mesmo que print(1, 2, 3)
#
# print_iter(product(*camisetas)):
#   camisetas é uma lista de listas. Ou seja, é um iterável que contém outros 
#   iteráveis
#   O asterisco * antes de camisetas é o unpacking q pega cada lista dentro 
#   de camisetas e a "desempacota" como um arg separado pra função product()