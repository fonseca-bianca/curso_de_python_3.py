...
desfazer_tarefa = []
tarefa_desfeita = lista_tarefas.remove("caminhar")
desfazer_tarefa.append("caminhar")
tarefa_desfeita = lista_tarefas.remove("fazer café")
desfazer_tarefa.append("fazer café")
