...
print(len(person))  # 2
print(list(person.keys()))  # dict_keys(['nome', 'sobrenome'])
print(list(person.values()))  # dict_values(['Luiz Gustavo', 'Miranda'])
print(list(person.items()))  # dict_items([('nome', 'Luiz Gustavo'), 
# ('sobrenome', 'Miranda')])