...
# é incluído
contagem_regressiva_digito_10 = 10

resultado_digito_10 = 0
for digito_10 in soma_nove_digitos:
    multiplicacao_digitos = int(digito_10) * contagem_regressiva_digito_10 
    # int(digito_10): converte a string pra inteiro
    print(digito_10, contagem_regressiva_digito_10, multiplicacao_digitos) 
    # aq vai mostrar cada dígito do CPF e seu equival na contagem regressiva
    resultado_digito_10 += multiplicacao_digitos # soma cada multiplicação
    # do laço 'for' no 'resultado_digito_1'
    contagem_regressiva_digito_10 -= 1 # mostra a contagem regressiva (decrem)

print(f"A soma de todos os números multiplicados é: {resultado_digito_10}")

obter_digito_10 = ((resultado_digito_10 * 10) % 11) # primeiro: multiplica
# depois obtém o resto da divisão do valor por 11
obter_digito_10 = obter_digito_10 if obter_digito_10 <= 9 else 0 # ternário
print(obter_digito_10)
...
# NÃO é incluído
contagem_regressiva_digito_11 = 11 # os 10 primeiros dígitos são multiplicados 
# pela seq regressiva começando em 11 

resultado_digito_11 = 0 # irá armazenar o somatório das multiplicações

# loop 'for' irá percorrer cada um dos 10 primeiros dígitos armazenados na 
# variável 'soma_dez_digitos'
for digito_11 in soma_dez_digitos:
    multiplicacao_digitos = int(digito_11) * contagem_regressiva_digito_11 
    # int: 
    # converte a string pra inteiro
    print(digito_11, contagem_regressiva_digito_11, multiplicacao_digitos) 
    resultado_digito_11 += multiplicacao_digitos # 'resultado_digito_2': 
    # a soma dos resultados das multiplicações é colocado aq
    contagem_regressiva_digito_11 -= 1 

print(f"A soma de todos os números multiplicados é: {resultado_digito_11}")

# 'obter_digito_2': calcula o último dígito do CPF (o 2º verificador)
obter_digito_11 = ((resultado_digito_11 * 11) % 11) 
...
obter_digito_11 = obter_digito_11 if obter_digito_11 <= 9 else 0 # ternário
# ternário: se o valor de 'obter_digito_2' for MAIOR q 9, será ajustado pra 0
print(obter_digito_11)

print("----------------------------------------------------------------")

# Validação do CPF
cpf_completo = f"{soma_nove_digitos}{obter_digito_10}{obter_digito_11}" # 11 
