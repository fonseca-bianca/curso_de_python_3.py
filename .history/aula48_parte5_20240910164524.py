...
lista_a[0] = "Mexe na lista_a e altera o mesmo valor na lista_b" # pq ambas apontam pro mesmo valor na memória"
print(lista_b)

# utilizando método 'copy'
lista_a = ["João", "Maria", "Tyrion"]
lista_b = lista_a.copy() # retornar os valores da 'lista_a' pra 'lista_b' (lá no print)
