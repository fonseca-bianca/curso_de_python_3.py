...
ex.:
    s2 = set('Luiz')
    print(s2)
    # output: {'L', 'i', 'u', 'z'} --> imprime sem ordem e um iterável por vez
    
        ** Portanto, pra strings, prefira:
            s2 = {'Luiz}
            print(s2)
            # output: 'Luiz' --> imprime na ordem certinha 
...
- .discard(): 
    ...
    s1.discard("olá mundo") # vai eliminar o 'olá mundo'
