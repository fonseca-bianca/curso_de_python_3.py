...
# f"{lista=}": mostra o nome da variável e seu valor no formato → lista=[...]
# falsy(lista): chama a função falsy() passando lista como argumento e imprime 
# o resultado ('falsy' ou 'truthy')
...
print(f"TESTE_COM_STRING=", falsy("TESTE_COM_STRING"))
