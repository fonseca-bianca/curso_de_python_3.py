...
"""DECIMAL IMPORT
Corrige problema de precisão de números decimais finais de um número muito GRANDE, p.ex
...
OBS.: 
Passar, ao invés de um FLOAT, umas STRING, pq daí a função Decimal vai fazer a lógia
pra converter a STRING em FLOAT. O mais indicado é q fique assim:
numero1 = decimal.Decimal('0.1')
numero2 = decimal.Decimal('0.7')
"""