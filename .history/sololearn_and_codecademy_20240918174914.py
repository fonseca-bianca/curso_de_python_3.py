...
print(str(pi))
""""""
OBS.: Métodos q usam notação 'ponto' como .upper() funcionam APENAS com string
Já os demais tipos SEM o 'ponto' funcionam com QLQR outro tipo de dado
...
Se você quiser imprimir uma variável que é um inteiro, você pode “preenchê-la” 
com zeros usando %02d. O 0 (zero) significa “preencher com zeros”, 
o 2 significa preencher com 2 caracteres de largura, e o 'd' 
significa que o número é um inteiro assinado (pode ser positivo ou negativo).
"""