...
if person.get('sobrenome') is None: # qndo chave inexistente, o retorno padrão é 'NONE'
...
chaves e valores armazenados no dicionário person, como {'nome': 'Luiz Gustavo', 
'nome_completo': 'R. R. Martin'}.
-------------------------------------------------------------------------------
...
o comando imprimirá "R. R. Martin". Se você quisesse imprimir "Agatha Christie", 
teria que fazer isso ANTES de sobrescrever o valor dessa chave.
"""