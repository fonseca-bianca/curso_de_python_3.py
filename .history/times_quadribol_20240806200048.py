...
def inserir_dados():
	...
	for i in range(1, 9):
		...
		# 'time': é uma variável que recebe a classe 'TimesQuadribol' com seus atributos
		# 'time' logo, é um Objeto criado -> o mesmo que Instância da classe Time
		# construtor da classe TimesQuadribol e seus aributos são chamados e inicializados
