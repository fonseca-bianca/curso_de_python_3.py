...
# pra não precisar colocar um monte de vírgulas ou concatenações pra escrever uma frase
...
linha_1 = f'{nome_completo} tem {altura:.2f} metros de altura, pesa {peso} quilos e seu IMC é {imc:.2f}.'
print(linha_1)
