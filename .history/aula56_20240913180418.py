...
#split():
lista_palavras = frase.split(", ") #divide string onde há vírgula seguida de espaço
...
for indice, frase in enumerate(lista_palavras):
    print(lista_palavras[indice].strip()) #remove vírgula e espaço em branco início e final
    
#join(): informar na string qual o separador q irá utilizar
#une os iteráveis dentro dos parênteses
frases_unidas = "".join(frase, frase2)
