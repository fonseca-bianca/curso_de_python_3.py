...
estrutura iterável, mas não pode ser utilizado diretamente para acessar 
índices dessa lista coletada. A razão para isso é que * é um operador de 
expansão de argumentos, e seu propósito é coletar múltiplos valores em uma 
estrutura iterável, não para acessar diretamente elementos de uma estrutura 
após a coleta. Somente é possível acessar um índice específico com o resto 
se ele for declarado como uma variável
"""

string_letra = "ABCD"
lista_nomes = ["Amy Lee,", "Kurt Cobain,", "Axl Rose,", \
                1, 2, 3, "e Whitney Houston"]
...
#   int(a, c, *_) --> a = Amy Lee, c = Axl Rose, 
        # *_ (resto) = vai imprimir 1,2,3, "e Whitney Houston"
        # como uma única lista

a, b, quarto_elemento, *_, u = lista_nomes # e pega o 'u' (último elemento da lista)
print(a, u, quarto_elemento) # vai imprimir somente Amy Lee e Whitney Houston (1º e último elem)
