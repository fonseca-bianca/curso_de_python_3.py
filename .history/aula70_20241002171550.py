...
def soma(x, y):
    ...
    return x + y # aq ´é como se fosse o 'else', mas NÃO precisa especificar, 
                 # pq se a outra condição for FALSE, então o 2º return será lido
...
Seria porque a frase "Olha só que legal" estaria nos lugares de 'x' e 'y' da função def soma???
...
--> O fluxo de execução é o seguinte:
    ...
    Chama soma(1, 1): imprime "Olha", "só", "que", "legal", e depois retorna 2.
    Chama soma(2, 2): imprime "Olha", "só", "que", "legal", e depois retorna 4.
