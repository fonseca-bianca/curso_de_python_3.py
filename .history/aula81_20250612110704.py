...
anônima (NÃO TEM NOME e NÃO tem parênteses) que contém apenas uma linha. Ou 
seja, tudo deve ser contido dentro de uma única expressão.
lista = [
...
# lista_nomes.sort(key=ordena) # sem uso .sort()
