...
if nome and idade:       
    ...
    # remove primeiro argumento (" " = espaço) pelo segundo argumento 
    # ("" = string vazia)
    # transformamos string 'nome' em string 'nome_sem_espaco' com espaços 
    # removidos  
    
    nome_sem_espaco = nome.replace(" ", "") # substitui espaço por SEM espaço
