...
class Partida:
    ...
    def pontuacao(self):
        while True:
            ...
            # Atualizar o tempo decorrido após cada evento
            tempo_decorrido = time.time() - self.inicio
...
if __name__ == "__main__":
    time1 = TimesQuadribol("Time1", "Grito Time1", 2000)
    time2 = TimesQuadribol("Time2", "Grito Time2", 2005)
