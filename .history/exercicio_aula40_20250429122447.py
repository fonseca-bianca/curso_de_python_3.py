...
while True:
    ...
    # é melhor escolher deixar maísuculo ou minúsculo justamente pra depois
    # não precisar ficar tendo q fazer checagem entre o q foi digitado pelo
    # usuário e o q o programa pede ('S' ou 's')
    
    # .startswith(): confere se string começa com a letra q se quer conferir
    
    # OBS.:
        # método .startswith() retorna um Bool, pode dar erro de tipagem, pq
        # a função input() retorna uma str e o método .startswith() retorna um 
        # bool, por isso, colocando o método .startswith() logo após a 
        # função input(), é como dizer ao programa: "o q vier após a str, 
        # vc mantém o mesmo tipo"
