...
while i < len(frase):
    ...
    if qtd_vezes_letra < letra_mais_vezes:

    print(letra_atual, qtd_vezes_letra) #vai aparecer a letra e ao lado a qntdade de vzs q ela apareceu. Espaço em branco tbm é caractere
