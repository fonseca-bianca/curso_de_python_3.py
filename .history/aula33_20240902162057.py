...
#string[:4]: pega a partir do 5º caractere e vai até o final da string original, ou seja, "a Fonseca"
outra_string = f'{string[:3]}123{string[4:]}'
print(string.zfill(20)) #.zfil(): preenche com ZER0S à esquerda até chegar no total de 20 cartacteres
print(outra_string)
