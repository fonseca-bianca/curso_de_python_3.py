qnt_linhas = 5
qnt_colunas = 5
qtd_colunas_internas = 5

linha = 1 # é o contador das linhas
# linha = 0

# como se fosse uma engrenagem grande e uma pequena. Sempre que a grande 
# rodar, no caso, o while 'linha' rodar, aí a pequena (while coluna), irá 
# rodar tbm
