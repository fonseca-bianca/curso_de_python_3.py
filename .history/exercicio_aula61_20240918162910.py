...
for digito in soma_nove_digitos:
    ...
    print(digito, contagem_regressiva, int(digito) * contagem_regressiva) # aq vai mostrar cada dígito do CPF e seu equivalente na contagem regressiva
    contagem_regressiva -= 1 # mostra a contagem regressiva

    resultado_todos_digitos += contagem_regressiva
print(resultado_todos_digitos)
