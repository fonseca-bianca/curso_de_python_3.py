...
# loop 'while' irá continuar até que o índice 'i' seja menor que o comprimento
# da variável 'string'
while i < len(string):
    # a cada iteração do loop, a variável 'letra' armazena o caractere na 
    # posição 'i' da 'string'
    letra = string[i]
...
else: # bloco que é executado somente quando o bloco 'while' foi completamente 
    # executado
