...
for digito_10 in soma_nove_digitos:
    multiplicacao_digitos = int(digito_10) * contagem_regressiva_digito_10 # int: 
    # converte a string pra inteiro
    print(digito_10, contagem_regressiva_digito_10, multiplicacao_digitos) # aq vai 
    ...
    contagem_regressiva_digito_10 -= 1 # mostra a contagem regressiva
...
# NÃO é incluído
contagem_regressiva_digito_11 = 11 # os 10 primeiros dígitos são multiplicados pela 
...
for digito_11 in soma_dez_digitos:
    multiplicacao_digitos = int(digito_11) * contagem_regressiva_digito_11 # int: 
    # converte a string pra inteiro
    print(digito_11, contagem_regressiva_digito_11, multiplicacao_digitos) # aq vai 
    # mostrar cada dígito do CPF e seu equivalente na contagem regressiva
    resultado_digito_11 += multiplicacao_digitos # 'resultado_digito_2': 
    # a soma dos resultados das multiplicações é colocado aq
    contagem_regressiva_digito_11 -= 1 # mostra a contagem regressiva (decremento)
