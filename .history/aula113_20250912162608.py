...
# no caso, reduzir o iterável (produtos) a um único valor (soma dos preços)
produtos = [
...
#     funcao_do_reduce,
#     produtos,
#     0 # esse é o valor inicial do acumulador
# )

# output:
# Acumulador: 0
# Produto atual: {'nome': 'Produto 5', 'preco': 10.0}

# Acumulador: 10.0
# Produto atual: {'nome': 'Produto 1', 'preco': 22.32}

# Acumulador: 32.32
# Produto atual: {'nome': 'Produto 3', 'preco': 10.11}

# Acumulador: 42.43
# Produto atual: {'nome': 'Produto 2', 'preco': 105.87}

# Acumulador: 148.3
# Produto atual: {'nome': 'Produto 4', 'preco': 69.9}

# A soma total de todos os acumuladores é: 218.20

print()
# escrevendo a função acima na versão lambda (mais sucinta):
soma_total = reduce(
...
# output: A soma total de todos os acumuladores é: 218.20