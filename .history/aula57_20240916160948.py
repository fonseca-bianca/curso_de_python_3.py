...
""" variável lord dentro do loop for corresponde a cada uma das sublistas dentro
da lista lord_of_rings.
lord será, em cada iteração, uma das listas aninhadas (internas) de lord_of_rings
"""
