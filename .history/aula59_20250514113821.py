...
a, b, indice_4, *_, u, indice_4 = lista_nomes # e pega o 'u' (último elemento da lista)
print(a, u, indice_4) # vai imprimir somente Amy Lee e Whitney Houston (1º e último elem)
