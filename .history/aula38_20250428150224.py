...
# como se fosse uma engrenagem grande e uma pequena. Sempre que a grande rodar,
# a pequena irá rodar tbm
...
# - inicializado somente 1x permanecendo o valor de 'linha' constante durante 
# todo o código
# - enquanto valor de linha constante, o valor de coluna é incrementado a 
# cada linha
