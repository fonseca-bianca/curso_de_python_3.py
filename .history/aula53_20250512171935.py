...
# OBS.:
    # Normalmente, o enumerate é colocado dentro de um for, pq ele é um iterator
    # e, por isso, ele não é colocado diretamente em uma variável, pq é como se
    # criasse sempre um novo iterator, logo, os valores NUNCA se esgotariam



# print(lista1)
# print(next(lista_enumerada), type(lista_enumerada)) # retorna: <enumerate 
# object at 0x000002081D8B2A70>: núm do objeto lista na memória do programa


# para cada tupla, ele vai separar o indice e o desenho. O 'for' abaixo é o
# mais simples
