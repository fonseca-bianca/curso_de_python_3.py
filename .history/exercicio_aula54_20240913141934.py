...
while True: # loop principal
    ...
    if len(opcao) > 1:
        ...
        continue # volta pro início do programa qndo usuário erra. Qndo acerta, o programa avança
    ...
    if opcao == "i":
        ...
        except Exception: # caso o programa caia em um erro q NÃO seja os erros anteriores
