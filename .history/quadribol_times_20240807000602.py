...
def criar_teams():
    ...
    for i in range(1, 3):  # Ajustei para criar dois times
        ...
        team = Quadribol_Teams(nome, grito_de_guerra, ano_de_fundacao)
        teams.append(team)
...
if __name__ == "__main__":
    teams = criar_teams()
    for team in teams:
        team.mostrar_informacoes_teams()