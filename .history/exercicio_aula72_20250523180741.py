...
def multiplies_all(*args): 
    return math.prod(args) 
# math.prod(args): calcula o produto de todos os valores passados na função

result = multiplies_all(1, 2, 3, 4, 5, 6, 7) 
# var 'resultado' armazena produto total
...
# retorno da função 'par_ou_impar' armazenado na var 'retorno_par_ou_impar'
return_even_or_odd = even_or_odd(result)
print(return_even_or_odd)


#               OU 
# a função par_ou_impar() poderia ser escrita com o 'print' ao invés do 
# 'return', assim:
