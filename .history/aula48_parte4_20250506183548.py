...
# vai mexer no valor colocado no objeto. No caso acima, ele vai mexer 
# diretamente
# na 'minha_lista_a'. Por isso, no print, deve-se colocar o objeto q foi mudado
# print(minha_lista_a) --> retorna: [1, 2, 3, 4, 5, 6, 7, 8]