...
def ordena(item): # Define uma função simples que retorna a nota de cada aluno
    return item['nota']
...
# (ex: 'A'), e 'grupo' é o iterador com os alunos daquela nota.
    ...
    print()
    # Adiciona uma linha em branco para separar os grupos, tornando a saída mais fácil de ler.
