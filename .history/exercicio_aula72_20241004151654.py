...
print(f"O resultado da multiplicação é: {resultado}") # total 5040

def par_ou_impar(resultado):
    if resultado % 2 == 0:
        return f"O resultado {resultado} é par"
    else:
        return f"O resultado {resultado} é ímpar."

# retorno da função 'par_ou_impar' armazenado na variável 'retorno_par_ou_impar'
retorno_par_ou_impar = par_ou_impar(resultado)
print(retorno_par_ou_impar)
