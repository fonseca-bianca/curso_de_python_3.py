...
# loop 'for' irá percorrer cada um dos 10 primeiros dígitos armazenados na variável 'soma_dez_digitos'
for digito_2 in soma_dez_digitos:
    ...
    resultado_digito_2 += multiplicacao_digitos # 'resultado_digito_2': a soma dos resultados das multiplicações é colocado aq
...
# 2º: o resto da divisão do valor por 11 é calculado usando '%'. O resto será o valor provisório do 2º verificador
...
cpf_completo = f"{soma_nove_digitos}{digito_1}{digito_2}" # 9 dígitos + dígito 1 + dígito 2 (após o traço) total = 11 dígitos + dígitos CPF
print(f"O CPF completo é: {cpf_completo}")

if cpf == cpf_completo:
    print("O CPF enviado pelo cliente é válido.")