...
- Mapeamento:
    lista NOVA tem q ter a MESMA quantidade de itens que a lista ORIGINAL
...
# lógica:
print("Produtos com novo valor com +5%:")
...
print("Produtos com novo valor com +5% se o preço for maior que 20:")
