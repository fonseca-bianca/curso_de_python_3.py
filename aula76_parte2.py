...
print(person) # {'nome': 'Luiz Gustavo'}
...
print(person)  # {'nome': 'Luiz Gustavo', 'sobrenome': 'Miranda', 
# 'nome_completo': 'Agatha Christie'}

# mostra o dicionário completo com Agatha Christie ANTES 
# de ter sido sobrescrita por R. R. Martin
print(person[key]) # Agatha Christie
...
print(person) # {'nome': 'Luiz Gustavo', 'nome_completo': 'R. R. Martin'}
