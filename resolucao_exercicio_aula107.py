...
def zipper(l1, l2):
    ...
    # retorna uma lista de tupla com índice l1 correspondente ao mesmo 
    # índice de l2
    return [
...
print(zipper(l1, l2)) # sem o 'RJ', pq puxamos apenas o tamanho da MENOR lista
...
print(list(zip_longest(lista_1, lista_2))) # sem fillvalue, aparece None
